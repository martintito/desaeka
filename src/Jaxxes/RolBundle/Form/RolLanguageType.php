 ...
 * de la entidad.
 */
class RolLanguageType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('language',null, array('label' => 'Idioma', 'attr' => array('class' => 'span3')))
            //->add('nivel','text', array('label' => 'Nivel', 'attr' => array('class' => 'span3')))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Jaxxes\RolBundle\Entity\RolLanguage',
        ));
    ...
    {
        return 'jaxxes_rolbundle_rollanguage';
    }
}
