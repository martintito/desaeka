...
class ICEM2130Baremo
{
     ...
     * @var string
     *
     * @ORM\Column(name="type_scale", type="string", length=10, nullable=true)
     */
    private $typeScale;
     ...
     * @var integer
     *
     * @ORM\Column(name="pd_min", type="smallint", nullable=true)
     */
    private $pdMin;
     ...
     * @var integer
     *
     * @ORM\Column(name="pd_max", type="smallint", nullable=true)
     */
    private $pdMax;
     ...
     * @var integer
     *
     * @ORM\Column(name="ce", type="smallint", nullable=true)
     */
    private $ce;
