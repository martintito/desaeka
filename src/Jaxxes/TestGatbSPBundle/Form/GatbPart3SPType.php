...
use Jaxxes\TestGatbSPBundle\Form\GatbPart3DetailSPType;
 ...
 * de la entidad.
 */
class GatbPart3SPType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder            
            ...
            * */
            ->add('gatbPart3',null)
            ->add('gatbSP',null)
            ->add('gatbPart3DetailSPs', 'collection', array('type' => new GatbPart3DetailSPType(), 'label' => 'Preguntas:') )
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Jaxxes\TestGatbSPBundle\Entity\GatbPart3SP',
        ));
    }

    public function getName()
    {
        return 'jaxxes_testgatbspbundle_gatbpart3sp';
    }
}
