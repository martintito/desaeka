...
use Jaxxes\TestGatbSPBundle\Form\GatbPart4DetailSPType;
 ...
 * de la entidad.
 */
class GatbPart4SPType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder            
            ...
            * */
            ->add('gatbPart4',null)
            ->add('gatbSP',null)
            ->add('gatbPart4DetailSPs', 'collection', array('type' => new GatbPart4DetailSPType(), 'label' => 'Preguntas:') )
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Jaxxes\TestGatbSPBundle\Entity\GatbPart4SP',
        ));
    }

    public function getName()
    {
        return 'jaxxes_testgatbspbundle_gatbpart4sp';
    }
}
