 ...
 * de la entidad.
 */
class GatbPart3DetailSPType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder            
            ...
            **/
            ...
            /**->add('gatbPart3','hidden', array('data' => 'abcdef',))**/
            ->add('gatbPart3Detail',null)
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Jaxxes\TestGatbSPBundle\Entity\GatbPart3DetailSP',
        ));
    }

    public function getName()
    {
        return 'jaxxes_testgatbspbundle_gatbpart3detailsp';
    }
}
