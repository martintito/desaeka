 ...
 * de la entidad.
 */
class GatbPart1SPType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder            
            ...
            * */
            ->add('gatbPart1',null, array('label' => 'Test :','attr' => array('class' => 'span5')))
            ->add('gatbSP',null, array('label' => 'Evaluado :','attr' => array('class' => 'span5')))
            ->add('gatbPart1DetailSPs', 'collection', array('type' => new GatbPart1DetailSPType(), 'label' => 'Preguntas:') )
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Jaxxes\TestGatbSPBundle\Entity\GatbPart1SP',
        ));
    }

    public function getName()
    {
        return 'jaxxes_testgatbspbundle_gatbpart1sp';
    }
}
