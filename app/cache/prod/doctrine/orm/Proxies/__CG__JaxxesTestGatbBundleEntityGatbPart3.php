 ...
 */
class GatbPart3 extends \Jaxxes\TestGatbBundle\Entity\GatbPart3 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Jaxxes\\TestGatbBundle\\Entity\\GatbPart3' . "\0" . 'id', '' . "\0" . 'Jaxxes\\TestGatbBundle\\Entity\\GatbPart3' . "\0" . 'descripcion', 'gatb');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GatbPart3 $proxy) {
