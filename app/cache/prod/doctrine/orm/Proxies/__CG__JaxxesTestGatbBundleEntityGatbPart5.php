...
namespace Proxies\__CG__\Jaxxes\TestGatbBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class GatbPart5 extends \Jaxxes\TestGatbBundle\Entity\GatbPart5 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Jaxxes\\TestGatbBundle\\Entity\\GatbPart5' . "\0" . 'id', '' . "\0" . 'Jaxxes\\TestGatbBundle\\Entity\\GatbPart5' . "\0" . 'descripcion', 'gatb');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GatbPart5 $proxy) {
