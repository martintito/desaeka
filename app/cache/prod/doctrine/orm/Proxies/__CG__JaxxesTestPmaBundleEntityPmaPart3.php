 ...
 */
class PmaPart3 extends \Jaxxes\TestPmaBundle\Entity\PmaPart3 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Jaxxes\\TestPmaBundle\\Entity\\PmaPart3' . "\0" . 'id', '' . "\0" . 'Jaxxes\\TestPmaBundle\\Entity\\PmaPart3' . "\0" . 'descripcion', 'pma');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PmaPart3 $proxy) {
