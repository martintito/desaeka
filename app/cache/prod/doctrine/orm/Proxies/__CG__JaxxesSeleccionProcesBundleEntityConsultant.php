 ...
 */
class Consultant extends \Jaxxes\SeleccionProcesBundle\Entity\Consultant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Jaxxes\\SeleccionProcesBundle\\Entity\\Consultant' . "\0" . 'id', 'nombre', 'login', 'password', 'salt');
        }
