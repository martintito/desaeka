 ...
 */
class GatbPart4 extends \Jaxxes\TestGatbBundle\Entity\GatbPart4 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Jaxxes\\TestGatbBundle\\Entity\\GatbPart4' . "\0" . 'id', '' . "\0" . 'Jaxxes\\TestGatbBundle\\Entity\\GatbPart4' . "\0" . 'descripcion', 'gatb');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GatbPart4 $proxy) {
