 ...
 */
class SectionbySelectionProcess extends \Jaxxes\SeleccionProcesBundle\Entity\SectionbySelectionProcess implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Jaxxes\\SeleccionProcesBundle\\Entity\\SectionbySelectionProcess' . "\0" . 'id', 'selectionProcess', 'sectionSelectedByResume', '' . "\0" . 'Jaxxes\\SeleccionProcesBundle\\Entity\\SectionbySelectionProcess' . "\0" . 'enable');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SectionbySelectionProcess $proxy) {
